        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm border-2 border-cottage-200 rounded-3xl p-8 shadow-2xl space-y-8">
            <section>
              ...
              <div className="pl-11 space-y-3 text-brown-700">
                ...
                <p>
                  • Remaining 50% due upon completion before final files are
                  delivered
                </p>
                <p>
                  • Payment accepted via PayPal, bank transfer, or Gcash for
                  local clients
                </p>
            ...
            <section>
              ...
              <div className="pl-11 space-y-3 text-brown-700">
                ...
                <p>
                  • Additional major changes beyond 3 revisions will incur an
                  extra 20 usd
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="pl-11 space-y-3 text-brown-700">
                <p>
                  • Standard turnaround time is 4-8 weeks depending on
                  complexity
                </p>
                <p>• Rush orders may be available for an additional 100% fee</p>
                <p>
                  • Delays due to client-side revision requests will extend
                  timeline
                </p>
                <p>
                  • You'll receive regular progress updates throughout the
                  process
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="pl-11 space-y-3 text-brown-700">
                <p>
                  • You have full rights to use the model for personal and
                  commercial purposes
                </p>
                <p>
                  • You may NOT redistribute, resell, or claim the rig as your
                  own work
                </p>
                <p>• Credit is appreciated but not required for personal use</p>
                <p>
                  • Commercial use must include credit in appropriate places
                </p>
                <p>• NDA during rigging will incur an additional 20 usd fee.</p>
                <p>
                  • I reserve the right to showcase the work in my portfolio
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="pl-11 space-y-3 text-brown-700">
                <p>
                  • Cancellations before work begins receive full refund minus
                  payment processing fees
                </p>
                <p>
                  • Once work has started, partial refunds based on work
                  completed
                </p>
            ...
            <section>
              ...
              <div className="pl-11 space-y-3 text-brown-700">
                <p>
                  • Final files delivered via Google Drive or similar cloud
                  service
                </p>
                <p>
                  • Includes model files, textures, and basic setup instructions
                </p>
                <p>
                  • Files backed up for 30 days after delivery for re-download
                  if needed
                </p>
          ...
          <div className="mt-8 text-center">
            <p className="text-brown-600 text-sm">
              Last updated: October 2025 • By commissioning, you agree to these
              terms
            </p>
          </div>
        </div>
